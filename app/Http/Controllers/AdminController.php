...
class AdminController extends Controller
{
     ...
     */
     ...
     public function check_auth_varification($data) {
        ...
        // Log the user in regardless of phone/email verification
        Auth::login($data);
        ...
        if ($data->type == 1 || $data->type == 3) {
            ...
            return redirect()->route('customer.account')->with('success', 'Successfully logged in.');
        }
