            ...
            <div class="row mb-9">
                                            ...
                                            <td class="cart__table--body__list">
                                                <div class="product__image two d-flex align-items-left">
                                                    <div class="product__thumbnail border-radius-5">
                                                        <a href="{{route('product.show', $product_info->slug)}}"><img class="border-radius-5 shadow rounded p-1" src="{{asset('images/product/' .optional($product_info)->thumbnail_image)}}" alt="{{ $product_info->title ?? 'cart-product' }}"></a>
                                                        <span class="product__thumbnail--quantity">{{$cart->qty}}</span>
                                                    </div>
                                                    <div class="product__description">
                                                        <h3 style="line-height: 24px !important;" class="product__description--name h4"><a href="{{route('product.show', $product_info->slug)}}">{{$product_info->title}}</a></h3>
                ...
                <div class="col-lg-7 pr-lg-4 mb-4 p-3">
                    ...
                    <div class="row gutter-sm">
                        <div class="col-xs-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="checkout__input--field border-radius-5" name="name" value="{{ optional(user())->name . ' ' . optional(user())->last_name }}" required>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label>Phone<span class="text-danger">*</span></label>
                                <input type="text" class="checkout__input--field border-radius-5" name="phone" value="{{ optional(user())->phone }}" required>
                            </div>
                        </div>
                        <div class="col-md-12 mb-5">
                            <div class="form-group">
                                <label>Email </label>
                                <input type="email" class="checkout__input--field border-radius-5" name="email" value="{{ optional(user())->email }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="shipping_address" id="" cols="30" rows="10" required placeholder="House number and street name" class="checkout__input--field border-radius-5 mb-2" >{{ optional(user())->address }}</textarea>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="hiddenradio d-flex">
                            <label class="text-center shadow rounded p-3 mx-3">
                              ...
                              <img width="100" class="rounded-pill" src="{{asset('assets/images/cod.png')}}" alt="cash on delivery">
                            ...
                            <label class="text-center shadow rounded p-3 mx-3 ">
                                ...
                                <img width="100" class="rounded-pill" src="{{asset('assets/images/bkash-logo.png')}}" alt="bkash logo">
                                <br><span class="">Online Payment</span>
                             </label>
                             @endif
                          

                              @if(Auth::check() && (optional(user())->wallet_amount >= $total_with_discount))
                                <label class="text-center shadow rounded p-3 mx-3" style="display: none;" id="wallet_select_body">
                                    ...
                                    <img width="100" class="rounded-pill" src="{{asset('assets/images/online-payment.jpg')}}" alt="online payment">
                                    <br><span>Use Wallet ({{optional(user())->wallet_amount}})</span>
                                </label>
                              @endif
                    ...
                    <div class="form-group mt-5  mb-3">
                        <div class="checkout__checkbox">
                            ...
                            @foreach($pages as $page)
                                <a href="{{ route('product.show', $page->page_slug) }}" 
                                    style="color:#F36D21;">{{$page->name}}, </a>
                            @endforeach
                            </label>
                        </div>
                    </div>
