                    ...
                    <div class="account__table--area">
                        ...
                        <form class="form account-details-form" action="{{ route('customer.account.update', Auth::id()) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly id="phone" name="phone" value="{{ user()->phone }}"
                                            class="checkout__input--field border-radius-5 mb-3">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-6">
                                ...
                                <input type="email" id="email_1" value="{{ user()->email }}" name="email" class="checkout__input--field border-radius-5 mb-3" readonly>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(user()->image != NULL)
                                        <img class="shadow rounded p-2" src="{{ asset('images/customer/'.user()->image) }}" alt="user image">
                                        @endif
                                    </div>
                                </div>
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(user()->nid != NULL)
                                        <img src="{{ asset('images/customer/nid/'.user()->nid) }}">
                                        @endif
                                    </div>
                                </div> --}}
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="display-name" name="address" value="{{ user()->address }}" class="checkout__input--field border-radius-5 mb-3 mb-0">
                            </div>
