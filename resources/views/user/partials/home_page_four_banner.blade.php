...
<section class="banner__section mt-5 mb-5" style="padding-bottom: 5rem !important;">
                    ...
                    <div class="col-lg-6 col-md-6 col-6">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="{{optional($first_banner)->link}}">
                                <img class="banner__items--thumbnail__img" src="{{ asset('images/middle-banner/'.optional($first_banner)->image) }}" alt="banner-img"> 
                    ...
                    <div class="col-lg-6 col-md-6 col-6">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="{{optional($second_banner)->link}}">
                                <img class="banner__items--thumbnail__img" src="{{ asset('images/middle-banner/'.optional($second_banner)->image) }}" alt="banner-img"> 
                                <div class="banner__items--content">
                                </div>
                            </a>
                        </div>
