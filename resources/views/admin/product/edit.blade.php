		      ...
		      @csrf
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-form-label"><b>Title</b> <span class="text-danger">*</span></label>
						<div class="">
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-8">
								<div class="row">
									<div class="form-group col-md-6">
										<label class="col-form-label"><b>Brand</b>  <span class="text-danger">*</span></label>
										<div class="">
											<select name="brand_id" class="select2 form-control @error('brand_id') is-invalid @enderror" required>
									...
									<div class="form-group col-md-6">
										<label class="col-form-label"><b>Unit Type</b>  <span class="text-danger">*</span></label>
										<div class="">
									...
									<div class="col-md-12">
										<div class="form-group row">
											<label class="col-sm-2 col-form-label"><b>Thumbnail</b> <span class="text-danger">*</span></label>
											<div class="col-sm-10">
							...
							<div class="col-md-4">
								<label class="col-form-label"><b>Category</b> <span class="text-danger">*</span></label>
								<select name="category_id" required class="form-control select2">
									...
									<?php
										$check_category = DB::table('product_with_categories')->where(['category_id'=>$category->id, 'product_id'=>$product->id])->first();
											?>
									<option  @if(!is_null($check_category)) selected @endif value="{{$category->id}}">{{ $category->title }}</option>
									@endforeach
								</select>
								@error('category_id')
								<span class="invalid-feedback" role="alert">
										...
										<div id="variations_div" class=" p-2">
											...
											<div class="row p-2 shadow rounded mb-4" id="variation_info_div_{{$variation->id}}">
												...
												<input type="hidden" name="new_or_old[]" value="old">
												  <div class="col-md-6">
													<div>
														@if(!empty($variation->color))<div class="p-2 shadow rounded"><b>Color: </b> <span style="background-color: {{optional($variation->color_info)->code}}; padding: 5px;">{{optional($variation->color_info)->name}}</span></div><br>@endif
							...
							@foreach ($filterHeads as $filterHead)
								<div class="col-md-4 col-sm-6 mb-4">
									<div class="card h-100 shadow-sm">
										<div class="card-header bg-light text-white py-2 px-3">
											<h6 class="mb-0">{{ $filterHead->name }}</h6>
										</div>
												...
												@foreach ($filterHead->options as $option)
													<li class="form-check mb-1">
														<input class="form-check-input filter-option"
															type="checkbox"
															name="filters[{{ $filterHead->id }}][]"
															value="{{ $option->id }}"
															{{ $product->options->contains('id', $option->id) ? 'checked' : '' }}
					...
					<div id="single" class="shadow rounded p-2 border row">
						<div class="form-group col-md-6">
							<label class=""><b>Price</b> <span class="text-danger">*</span></label>
						...
						<div class="form-group col-md-6">
							<label class="col-form-label"><b>Stock Quantity</b> <span class="text-danger">*</span></label>
					...
					<div class="col-md-12 my-3 mb-5">
						<div class="shadow row">
							...
							{{-- <div class="col-md-12">								
								<label>
									<input type="checkbox" name="call_for_price" {{ old('call_for_price', $product->call_for_price ?? false) ? 'checked' : '' }}>
									Call for Price
								</label>
							</div> --}}
					...
					<div class="form-group col-md-12">
						...
						<div class="">
							<textarea class="form-control @error('specification') is-invalid @enderror" name="specification">{{ $product->specification }}</textarea>
						</div>
					</div>
					<div class="form-group col-md-12">
