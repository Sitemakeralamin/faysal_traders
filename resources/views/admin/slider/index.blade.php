              ...
              <tr>
                ...
                <td>
                  <div class="row text-center">
                      ...
                      <div class="col">
                        <form action="{{ route('slider.destroy', ['id'=>$slider->id]) }}" method="get">
                        @csrf
                        <button type="submit" data-toggle="modal" title="Delete" class="btn btn-danger"><i class="fas fa-trash"></i></button>
                      </form>
                      </div>
