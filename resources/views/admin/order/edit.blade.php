            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-md-6 text-left">
                  <h4>
                  <img src="{{ asset('images/website/'.optional($business_info)->footer_logo.'') }}" width="200">
                  </h4>
                  <address>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      @foreach($order->order_product as $product)
                        ...
                        <tr>
                          <td>{{ $loop->index + 1 }}</td>
                          <td>{{ optional($product->product)->title }}<br><span class="cart__content--variant">{!!$variation_info!!}</span></td>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12 shadow rounded p-2">
                    <a href="{{ route('order.invoice.generate', $order->id) }}" class="btn btn-primary float-left" style="margin-right: 5px;" target="blank"><i class="fas fa-print" ></i> Print</a>
                  </div>
                  ...
                  <div class="col-md-12 mt-3 shadow rounded p-2">
                    <form action="{{ route('order.update', $order->id) }}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="delivery_charge" value="{{ $order->delivery_charge == NULL ? 0 : $order->delivery_charge }}" class="form-control">
                      </div>
                      <div class="form-group">
