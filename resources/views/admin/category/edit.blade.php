                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea name="bottom_description" class="tinymce form-control @error('description') is-invalid @enderror" placeholder="Description">{{ $category->bottom_description }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
